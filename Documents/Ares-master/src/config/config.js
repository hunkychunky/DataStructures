...
const envVarsSchema = Joi.object()
  .keys({
    ...
    PAYSTACK_BASE_URL: Joi.string().description('Base Paystack endpoint'),
    PAYSTACK_SECRET_KEY: Joi.string().description('Paystack secret key'),
    SENDGRID_API_KEY: Joi.string().description('Sendgrid api key'),
    WELCOME_TEMPLATE_ID: Joi.string().description('Sendgrid welcome template id'),
    WELCOME_EMAIL_NAME: Joi.string().description('Abdul Hafeez from Bazaar'),
    ...
    CORS_HOST: Joi.string().description('All cors host'),
  })
  .unknown();
